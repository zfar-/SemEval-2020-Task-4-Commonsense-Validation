...
import os
import numpy as np
from loader_task1 import convert_examples_to_features, convert_features_to_dataset, DataProcessor, LABEL2ID
from bert_dual_sent_classification import BertForDualSent
...
def main():
    ...
    model = BertForDualSent.from_pretrained(args.model_name_or_path, config=config, num_labels=2)
